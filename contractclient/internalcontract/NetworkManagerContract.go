...
import (
	...
	ethereum "github.com/nordicenergy/powerchain"
	...
	"github.com/nordicenergy/powerchain/event"
)
...
// ParsePrint is a log parse operation binding the contract event 0x4d0a4c762bd7f742096daaf5911dcf9c94b9ea95.
//
// Solidity: event print(string nodeName, string role, string publickey, string enode, string ip)
